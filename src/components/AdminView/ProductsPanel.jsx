...
import { SectionHeader, AddBtn, IconBtn, Th, Td, FormField, Modal, SaveBtn, ConfirmModal } from './shared';
...
export default function ProductsPanel({ products, setProducts, categories, showToast }) {
